...
class MT5Handler:
    ...
    def action(self):
        ...
        batch_accounts = chunks(accounts, math.ceil(len(accounts) / len(self.terminals)))
    ...
    def collect_data(self, terminal_idx, accounts):
        ...
        for account in accounts:
            ...
            try:
                ...
                histories, histories_orders, positions = self.get_deal_orders(cls, None)
                history = self.get_history(cls,saved_tickets,histories, histories_orders, positions)
                ...
                if first_balance_needed:
                    response['first_balance'] =self.get_first_balance(histories)
